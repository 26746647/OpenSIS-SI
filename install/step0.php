...
<body>
<div class="heading"><?php echo $step02; ?><!--, Please remember to read the <a href="../INSTALL.txt" target="_new">INSTALL.TXT</a> file first.-->
...
if($_GET["upreq"] == 'true')
{
 	echo '<td>'.$step04.'</td>';
    echo '</tr><tr>';
    echo '<td valign="middle" align="center"><a href="step0.1.php?mod=upgrade"><img src="images/upgrade.png" alt='.$step05.' width="122" height="150" border="0"/></a></td>';
...
{
    echo '<td valign="middle" align="center"><a href="step1.php"><img src="images/install.png" width="122" alt='.$step06.' height="150" border="0"/></a></td>';
    echo '<td valign="middle" align="center"><a href="step0.1.php?mod=upgrade"><img src="images/upgrade.png" alt='.$step05.' width="122" height="150" border="0"/></a></td>';
}
?>
	          </tr>
