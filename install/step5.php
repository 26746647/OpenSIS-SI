...
<table border=\"0\" width=\"500\" cellspacing=\"6\" cellpadding=\"3\" align=\"center\">
      <tr>
        <td  align=\"center\" style=\"padding-top:36px; padding-bottom:16px\">". $step56 ."</td>
      </tr>
	  <tr><td>
...
if($_SESSION['school_installed']=='both'){
	...
	$display_text=$step51 ." ".$_SESSION['sname']."". $step52 ."<br><br>". $step53;
#You have also installed the sample school data, you can access it by clicking on the drop down menu  of  the school select field.";
		...
		$display_text=$step51 ."".$_SESSION['sname']."". $step52;
...
<table border=\"0\" width=\"500\" cellspacing=\"6\" cellpadding=\"3\" align=\"center\">
      <tr>
        <td  align=\"center\" style=\"padding-top:36px; padding-bottom:16px\">". $step58 ."</td>
      </tr>
	  <tr><td>
	  <div>".$display_text."</div>
	  </td></tr>
...
<table border=\"0\" cellspacing=\"6\" cellpadding=\"3\" align=\"center\">
      <tr>
        <td  align=\"center\" style=\"padding-top:36px; padding-bottom:16px\">". $step59 ."</td>
      </tr>
