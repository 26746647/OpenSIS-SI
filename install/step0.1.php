    ...
    <tr>
      <td>
	      <table width="100%" style="height:270px;" border="0" cellspacing="12" cellpadding="12" align="center">
            <tr>
			 	<td valign="middle" align="center" colspan="2" style="font-size:14px;"><?php echo $step011; ?></td>
			</tr>
			<tr>
<?php

    echo '<td align="left"><a href="step0.php"><img src="images/go_back.png"  alt='. $step012 .'  border="0"/></a></td>';
    echo '<td align="right"><a href="step1.php?mod=upgrade"><img src="images/continue.png" alt="'. $step013 .' border="0"/></a></td>';
