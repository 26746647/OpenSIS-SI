...
<body>
<div class="heading"><?php echo $step32; ?>
<div style="background-image:url(images/step3_new.gif); background-repeat:no-repeat; background-position:50% 20px; height:270px;">
  <form name='step3' id='step3' method="post" action="ins3.php">
    <table border="0" cellspacing="2" cellpadding="3" align="center">
      <tr>
        <td  align="center" style="padding-top:40px; padding-bottom:10px"><?php echo $step33; ?></td>
      </tr>
	  <tr>        <td align="center" valign="top">
		<table width="400" border="0" cellpadding="0" align="center" cellspacing="0" id="table1">
		
		<tr><td>
		<div><?php echo $step34; ?></div>
		<div style="height:6px;"></div>
		<div>
		 <table width="100%" border="0" cellspacing="2" cellpadding="0" align="center">

                <tr>
                    <td align="left"><?php echo $step35; ?></td><td> : </td><td><input type="text" name="sname" id="sname" size="30" value=""  /></td>
            </tr>

            <!--
            </tr>
            <td align="center"><?php echo $step36; ?> : <input name="beg_date" id="beg_date" maxlength="25" size="10" type="Text" readonly>
                  <a href="javascript:NewCssCal('beg_date','mmddyyyy')" >
                            <img src="images/cal.gif" alt="Pick a date" height="16" width="16" border="0"></a></td>
            </tr>
             <tr>
                 <td align="center"><?php echo $step37; ?> : <input name="end_date" id="end_date" maxlength="25" size="10" type="Text" readonly>
           ...
           <!-- <tr>
             ...
             <tr>
            <td align="left"><?php echo $step36; ?> </td><td> : </td><td> <input name="beg_date" id="beg_date" maxlength="25" size="10" type="Text" readonly />
                   <a href="javascript:NewCal('beg_date','mmddyyyy')"><img src="images/cal.gif" width="16" height="16" border="0" alt="Pick a date" /></a></td>
            </tr>
             <tr>
                 <td align="left"><?php echo $step37; ?></td><td> : </td><td> <input name="end_date" id="end_date" maxlength="25" size="10" type="Text" readonly />
	  ...
	  <td align="center" valign="top"><input type="checkbox" name="sample_data" id="sample_data" value="insert" /><strong><?php echo $step38; ?></strong></td>
	</tr>
	</table>
	</div>
	<div style="height:6px;"></div>
