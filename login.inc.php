...
#
#  Sistema modified by SerInformaticos.es to convert this great soft to be
#  a multilanguage software
#
#  You can concat us at info@serinformaticos.es
#
#
#***************************************************************************************
// # FErArg
    ...
    <td valign='middle' height='100%'><table class='wrapper' border='0' cellspacing='0' cellpadding='0' align='center'>
                ...
                <td><table width='100%' border='0' cellspacing='0' cellpadding='0'>
                    <tr>
                      <td class='header_padding'><table width='100%' border='0' cellspacing='0' cellpadding='0'>
                          <tr>
                            <td class='header_txt'>". $login7 ."</td>
                          </tr>
                        </table></td>
                    </tr>";
					if($_REQUEST['maintain']=='Y'){
				echo "<tr><td align='center' style='color:red'><b>". $login6 ."</b></td></tr>";
					}
                    echo "<tr>
        ...
        <tr>
          <td class='footer' valign='top'><table width='100%' border='0' cellspacing='0' cellpadding='0'>
              ...
              <tr>
                <td align='center' class='copyright'>". $footer1 ."</td>
              </tr>
            </table></td>
        </tr>
      </table></td>
